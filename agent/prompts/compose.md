...
1. **Chọn khổ giấy** từ câu 1. Nó ràng buộc mọi thứ sau nó, nên chọn trước.
   Cùng lúc ấy, chọn **dáng trang**: một chồng khối dọc (bỏ `page`) hay một
   dải hẹp bên cạnh cho phần định danh (`page.style`). Dáng là hệ quả của câu
   1 và câu 2 — máy POS 58 mm không có chỗ cho dải bên; tờ sao kê mà kế toán
   dò số tài khoản trong lúc đọc bảng giao dịch thì có. Chọn sau khi đã xếp
   khối là chọn cho có.

   Cũng ở bước này: **mấy tờ?** Khổ giấy cắt sẵn cao bao nhiêu là biết trước
   khi in, nên chứng từ nhiều nội dung hơn một tờ chứa được là *hai tờ*, không
   phải một tờ cao gấp đôi (`page_order`). Hầu hết là một tờ; chỉ tờ nào bảng
   hàng thường dài mới cần tờ sau.
